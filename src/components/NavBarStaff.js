...
export default class NavBarStaff extends Component {
    constructor(props){
        super(props)
       this.state={
  ...
  <Navbar.Collapse id="basic-navbar-nav">
    <Nav className="mr-auto">
      <Nav.Link href={sessionStorage.getItem("home")}>Home</Nav.Link>
      ...
      <Nav.Link href={sessionStorage.getItem("schedule")}>My Schedule</Nav.Link>
      <NavDropdown title= "My Requests" id="collasible-nav-dropdown">
        <NavDropdown.Item href={sessionStorage.getItem("request")}>My Requests</NavDropdown.Item>
        <NavDropdown.Item href={sessionStorage.getItem("req2")}>Replacement Requests Received</NavDropdown.Item>
        <NavDropdown.Item href={sessionStorage.getItem("req1")}>Submit Request</NavDropdown.Item>
      </NavDropdown>
