...
export default class HODSelectCourse extends Component {
    constructor(props){
        super(props)
        this.state={
            course_name:"",
...
<Button style={{backgroundColor:'#0b1b3f'}} className = "b" variant="primary" type="submit" onClick = {this.changeS}>
view
</Button>
